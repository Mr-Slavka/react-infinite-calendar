...
var Day = function (_PureComponent) {
  ...
  Day.prototype.render = function render() {
    ...
    var _props2 = this.props,
        customСlassName = _props2.customСlassName,
    ...
    return _react2.default.createElement(
      ...
      _extends({
        ...
        className: (0, _classnames2.default)(styles.root, (_classNames = {}, _classNames[styles.today] = isToday, _classNames[styles.highlighted] = isHighlighted, _classNames[styles.selected] = isSelected, _classNames[styles.disabled] = isDisabled, _classNames[styles.enabled] = !isDisabled, _classNames), customСlassName),
